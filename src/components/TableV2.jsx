        ...
        <Fragment>
          ...
          <div className="container">
            ...
            <div className="one-div-to-hold-them-all">
              {/* row1 */}
              <div className="square"><Element  id={data[0]._id} atomicNumb={data[0].atomic_number} symbol={data[0].symbol} name={data[0].name} atomicWeight={data[0].atomic_weight} />
              </div>
              ...
              <div className="square"></div>
              <div className="square"></div>
              <div className="square"><Element onClick={this.handleClick}  atomicNumb={data[1].atomic_number} symbol={data[1].symbol} name={data[1].name} atomicWeight={data[1].atomic_weight} />
              </div>
              {/* row2 */}
