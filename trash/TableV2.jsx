          ...
          <div className="container">
            ...
            <div className={isClicked ? "blurredOutTable" : "one-div-to-hold-them-all"} onClick={isClicked === true ? () => this.checkIsClicked() : ''}>
              ...
              <div className={isClicked ? "disappear" : "square"} onClick={() => {
                ...
                <Element id={data[0]._id} atomicNumb={data[0].atomic_number} symbol={data[0].symbol} name={data[0].name} atomicWeight={data[0].atomic_weight} />
              </div>
              ...
              <div className={isClicked ? "disappear" : "square"} onClick={() => {
                ...
                <Element onClick={this.handleClick} atomicNumb={data[1].atomic_number} symbol={data[1].symbol} name={data[1].name} atomicWeight={data[1].atomic_weight} />
              </div>
              {/* row2 */}
              <div className={isClicked ? "disappear" : "square"} onClick={() => {
                this.setState({
